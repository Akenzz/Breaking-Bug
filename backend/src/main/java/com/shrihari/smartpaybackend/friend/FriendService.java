...
public class FriendService {
    ...
    public void sendFriendRequest(FriendRequestDto request) {
        ...
        if (request.getIdentifier() != null && !request.getIdentifier().isBlank()) {
            ...
            throw new ApiException("Identifier or phone number is required");
        }

        if (requester.getId().equals(receiver.getId())) {
            throw new ApiException("Cannot send friend request to yourself");
        }
        ...
        if (alreadyExists) {
            throw new ApiException("Friend request already exists or already friends");
        }
    ...
    public void acceptRequest(Long requestId) {
        ...
        if (!friendship.getReceiver().getId().equals(currentUser.getId())) {
            throw new ApiException("Only receiver can accept request");
        }
    ...
    public void rejectRequest(Long requestId) {
        ...
        if (!friendship.getReceiver().getId().equals(currentUser.getId())) {
            throw new ApiException("Only receiver can reject request");
        }
