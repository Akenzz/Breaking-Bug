...
public class GroupService {
    ...
    public void addMember(Long groupId, String identifier) {
        ...
        GroupMember adminCheck = groupMemberRepository
                ...
                .orElseThrow(() -> new ApiException("Not a group member"));

        if (adminCheck.getRole() != GroupRole.ADMIN) {
            throw new ApiException("Only admin can add members");
        }
        ...
        if (groupMemberRepository
                ...
                .isPresent()) {
            throw new ApiException("User already in group");
        }
    ...
    public List<GroupMemberResponse> getGroupMembers(Long groupId) {
        ...
        groupMemberRepository
                ...
                .orElseThrow(() -> new ApiException("Not a member of this group"));
    ...
    public void joinGroup(String code) {
        ...
        Group group = groupRepository.findByGroupCode(code)
                .orElseThrow(() -> new ApiException("Invalid group code"));

        if (groupMemberRepository
                .findByGroup_IdAndUser_Id(group.getId(), user.getId())
                .isPresent()) {
            throw new ApiException("Already a member");
        }
