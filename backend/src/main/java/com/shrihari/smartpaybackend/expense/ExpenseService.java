...
public class ExpenseService {
    ...
    public ExpenseResponse createExpense(CreateExpenseRequest request) {
        ...
        if (request.getSplitType() == SplitType.EQUAL) {
            ...
            if (request.getUserIds() == null || request.getUserIds().isEmpty()) {
                throw new ApiException("Users required for equal split");
            }
            ...
            for (Long userId : request.getUserIds()) {
                ...
                groupMemberRepository
                        ...
                        .orElseThrow(() -> new ApiException("User not in group"));
        ...
        if (request.getSplitType() == SplitType.EXACT) {
            ...
            if (request.getExactSplits() == null ||
                ...
                throw new ApiException("Exact splits required");
            }
            ...
            if (total.compareTo(request.getAmount()) != 0) {
                throw new ApiException("Exact split total mismatch");
            }
    ...
    private void createExpenseFromSplit(Group group,
        ...
        if (request.getSplitType() == SplitType.EXACT) {
            ...
            if (total.compareTo(request.getAmount()) != 0) {
                throw new ApiException("Split total does not match amount");
            }
    ...
    public void cancelExpense(Long expenseId) {
        ...
        if (expense.isCancelled()) {
            throw new ApiException("Expense already cancelled");
        }
    ...
    public void editExpense(Long expenseId,
        ...
        authorizationService.validateGroupMember(expense.getGroup().getId());
        if (expense.isCancelled()) {
            throw new ApiException("Cannot edit cancelled expense");
        }
        ...
        if (request.getSplitType() == SplitType.EXACT) {
            ...
            if (total.compareTo(request.getAmount()) != 0) {
                throw new ApiException("Split total mismatch");
            }
